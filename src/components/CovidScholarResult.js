...
Result.propTypes = {
    ...
    journalField: PropTypes.string,
    authorsField: PropTypes.string,
    publicationDateField: PropTypes.string,
    abstractField: PropTypes.string,
    hasYearField: PropTypes.string,
    hasMonthField: PropTypes.string,
    hasDayField: PropTypes.string,
