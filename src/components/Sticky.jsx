...
var Sticky = function (_Component) {
  ...
  function Sticky() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Sticky.__proto__ || Object.getPrototypeOf(Sticky)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (new_state.isSticky !== _this.state.isSticky || new_state.wasSticky !== _this.state.wasSticky ||
        new_state.distanceFromTop !== _this.state.distanceFromTop ||
        new_state.distanceFromBottom !== _this.state.distanceFromBottom ||
        new_state.calculatedHeight !== _this.state.calculatedHeight) {
